                            ...
                            <div className="newsletter basis-1/3 pl-7 max-md:basis-full max-md:pl-0">
                                ...
                                <div className="list-social flex items-center gap-6 mt-4">
                                    ...
                                    <a href="https://www.twitter.com/" target="_blank">
                                        <TwitchIcon className="icon-twitter text-2xl text-black"/>
                                    </a>
                                    <a href="https://www.youtube.com/" target="_blank">
                                        <YoutubeIcon className="icon-youtube text-2xl text-black"/>
                                    </a>
                                    <a href="https://www.pinterest.com/" target="_blank">
                                        <AppleIcon className="icon-pinterest text-2xl text-black"/>
                                    </a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="footer-bottom py-3 flex items-center justify-between gap-5 max-lg:justify-center max-lg:flex-col border-t border-line">
                        ...
                        <div className="right flex items-center gap-2">
                            ...
                            <div className="payment-img">
                                <img src="public/visa.jpg" alt="payment" className="w-9" />
                            </div>
                            <div className="payment-img">
                                <img src="public/mastercard.jpg" alt="payment" className="w-9" />
                            </div>
                            <div className="payment-img">
                                <img src="public/amex.jpg" alt="payment" className="w-9" />
                            </div>
                            <div className="payment-img">
                                <img src="public/paypal.jpg" alt="payment" className="w-9" />
                            </div>
                            <div className="payment-img">
                                <Image src="public/diner.jpg" alt="payment" className="w-9" />
                            </div>
                            <div className="payment-img">
                                <Image src="public/discover.jpg" alt="payment" className="w-9" />
                            </div>
                        </div>
                    </div>
                </div>
